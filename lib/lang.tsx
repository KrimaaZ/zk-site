...
const en: T = {
  ...
  tagline: '🔥 KRIMAA — ITS UR MISSION NOW 💪', enter: 'Enter →',
  welcomeBack: 'Welcome back, MAK', latestActivity: 'Latest Activity',
...
const fr: T = {
  ...
  tagline: '🔥 KRIMAA — ITS UR MISSION NOW 💪', enter: 'Entrer →',
  welcomeBack: 'Bon retour, MAK', latestActivity: 'Activité récente',
